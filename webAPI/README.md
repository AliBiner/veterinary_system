...
- Kendi isminizle Postman'de bir collection oluşturun. Tüm API endpointlerini ilgili entity'ye göre bu colleciton'a klasör klasör kaydedin. (Kaydedilen request JSON gönderiyorsa, JSON dataları da bulunsun)  Bu collection'ı export ederek  proje klasörüne ekleyin ve github’ınıza pushlayın.
